...
const packages = ['vue', 'react', 'svelte', 'angular', 'solid-js', 'next', 'hono', 'fastify', 'nuxt', 'astro', 'supabase', '@adonisjs/core', '@strapi/strapi', 'directus', 'lodash', 'date-fns', 'express', 'h3', 'nitropack', 'typescript', 'vite']
